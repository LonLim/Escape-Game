...
void setup() {
  ...
  display5.setSegments(data);// fill display 5 with whatever data[] array has
  display6.setSegments(data);// fill display 6 with whatever data[] array has  
  display7.setSegments(data);// fill display 7 with whatever data[] array has
  display8.setSegments(data);// fill display 8 with whatever data[] array has
  display9.setSegments(data);// fill display 9 with whatever data[] array has
  display10.setSegments(data);// fill display 10 with whatever data[] array has  
  display11.setSegments(data);// fill display 11 with whatever data[] array has
  display12.setSegments(data);// fill display 12 with whatever data[] array has  
...
void loop() {
  ...
  display1.showNumberDec(array[row][0], 0, array[row][1]);// display 1

  display2.setSegments(data);// fill(clear) display with data[] array  
  display2.showNumberDec(array[row][2], 0, array[row][3]);// display 2

  display3.setSegments(data);// fill(clear) display with data[] array
  display3.showNumberDec(array[row][4], 0, array[row][5]);// display 3

  display4.setSegments(data);// fill(clear) display with data[] array
  display4.showNumberDec(array[row][6], 0, array[row][7]);// display 4
  
  display5.setSegments(data);// fill(clear) display with data[] array
  display5.showNumberDec(array[row][8], 0, array[row][9]);// display 5

  display6.setSegments(data);// fill(clear) display with data[] array  
  display6.showNumberDec(array[row][10], 0, array[row][11]);// display 6

  display7.setSegments(data);// fill(clear) display with data[] array
  display7.showNumberDec(array[row][12], 0, array[row][13]);// display 7

  display8.setSegments(data);// fill(clear) display with data[] array
  display8.showNumberDec(array[row][14], 0, array[row][15]);// display 8
  
  display9.setSegments(data);// fill(clear) display with data[] array
  display9.showNumberDec(array[row][16], 0, array[row][17]);// display 9

  display10.setSegments(data);// fill(clear) display with data[] array  
  display10.showNumberDec(array[row][18], 0, array[row][19]);// display 10

  display11.setSegments(data);// fill(clear) display with data[] array
  display11.showNumberDec(array[row][20], 0, array[row][21]);// display 11

  display12.setSegments(data);// fill(clear) display with data[] array
  display12.showNumberDec(array[row][22], 0, array[row][23]);// display 12

  delay(3000);// wait for TEST_DELAY miliseconds
